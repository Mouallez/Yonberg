...
$wp_customize->add_panel('appearance', array(
    ...
    $wp_customize->add_setting('zeal_theme_width', array(
        'default' => 'boxed',
        'transport' => 'refresh',
        'sanitize_callback' => 'zeal_sanitize'
    ));

    $wp_customize->add_control('zeal_theme_width', array(
        'type' => 'radio',
        'section' => 'template_width',
        'label' => __('Template Width', 'zeal'),
        'description' => __('Select the width of the site template', 'zeal'),
        'choices' => array(
            'full'      => __('Full Screen', 'zeal'),
            'boxed'      => __('Boxed', 'zeal'),
        )
    ));
...
//                'teal'      => __('Teal', 'zeal'),
//                'teal2'      => __('Teal', 'zeal'),
//                'green2'     => __('Green', 'zeal'),
//                'blue'      => __('Blue', 'zeal'),
//                'blue2'      => __('Blue', 'zeal'),
//                'yellow'      => __('Yellow', 'zeal'),
//                'orange'    => __('Orange', 'zeal'),
//                'red'       => __('Red', 'zeal'),            
//                'pink'      => __('Pink', 'zeal'),
//                'pink2'      => __('Pink', 'zeal'),
//                'purple'       => __('Purple', 'zeal'),
//            )
//        ));
        
        // Primary Color
        $wp_customize->add_setting( 'zeal_skin_color_primary', array (
            'default'               => '#3eb3b1',
            'transport'             => 'refresh',
            'sanitize_callback'     => 'zeal_sanitize_text'
        ) );
        $wp_customize->add_control( 
            ...
            $wp_customize, 
            'zeal_skin_color_primary', 
            array(
                    'label'         => __( 'Primary Theme Color', 'zeal' ),
                    'section'       => 'color',
                    'settings'      => 'zeal_skin_color_primary',
            ) ) 
        );
        
        // Secondary Color
        $wp_customize->add_setting( 'zeal_skin_color_secondary', array (
            'default'               => '#57DBD9',
            'transport'             => 'refresh',
            'sanitize_callback'     => 'zeal_sanitize_text'
        ) );
        $wp_customize->add_control( 
            new WP_Customize_Color_Control( 
            $wp_customize, 
            'zeal_skin_color_secondary', 
            array(
                    'label'         => __( 'Secondary Theme Color', 'zeal' ),
                    'label'         => __( 'For best results, make this a slightly darker or lighter version of your Primary color', 'zeal' ),
                    'section'       => 'color',
                    'settings'      => 'zeal_skin_color_secondary',
            ) ) 
        );
    ...
    $wp_customize->add_section('zeal_fonts_section', array(
        ...
        $wp_customize->add_control('zeal_font_primary', array(
            ...
            'label' => __('Primary Font', 'athena'),
            'description' => __('Select the primary font of the theme', 'athena'),
            'choices' => zeal_fonts()
        ));
        ...
        $wp_customize->add_control('zeal_font_secondary', array(
            'type' => 'select',
            'section' => 'zeal_fonts_section',
            'label' => __('Secondary Font', 'athena'),
            'description' => __('Select the secondary font of the theme', 'athena'),
            'choices' => zeal_fonts()
        ));
