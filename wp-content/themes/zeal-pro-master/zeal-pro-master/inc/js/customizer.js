...
jQuery( document ).ready( function( $ ){
    ...
    $('#customize-info .preview-notice').html('<a class="button button-primary" href="https://github.com/smartcatdev/docs/blob/master/zeal.pdf" target="_BLANK">Zeal Documentation</a>');
//    $('#customize-info .preview-notice').append('<p style="color: #cc0000">The pro version includes more colors, the ability to add more slides on the frontpage, more font options, an animated Ajax contact form, testimonials, FAQs, Events and more!</p>');
