      ...
      ?><script>  
        ...
        jQuery(document).ready(function(){
          ...
          function cdiadrenreg() {
            newadrstructure = { 'l1': $('#formmodiflignes #ligne1').val(), 'l2': $('#formmodiflignes #ligne2').val(), 'l3': $('#formmodiflignes #ligne3').val(), 'l4': $('#formmodiflignes #ligne4').val(), 'cp': $('#formmodiflignes #postcode').val(), 'vi': $('#formmodiflignes #city').val() };
            var data = { 'action': 'cdi_ajax_gateway', 'case': '3', 'order': elOrder, 'newadr': newadrstructure, };
            var ajaxurl = '<?php echo $ajaxurl; ?>';
            jQuery.post(ajaxurl, data, function(response) {
              location.reload();
