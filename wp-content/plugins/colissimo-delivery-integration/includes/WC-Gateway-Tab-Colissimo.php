...
?>
      <div class="wrap">
        ...
        <form method="post" id="test">
          <div style="display:inline-block;">
            ...
            <a style="display:inline-block;"> <?php  self::cdi_debug_open_button() ; ?></a>
      ...
      if (WC_function_Colissimo::cdi_isconnected()) {
        ...
        <div id="debugmanagewrap">
          <div id="debugmanage" style="display:none;">
            ...
            <textarea id="cdi-debug-area" style="font-size: 14px;width: 98%; height:calc(100vh - 300px);"></textarea>
    ...
    if (WC_function_Colissimo::cdi_isconnected()) {
      ...
      ?><em></em><input type="button" id="cdi-debug-open" class="mode-run" value="<?php _e( 'Debug View', 'colissimo-delivery-integration' ); ?>" style="float: left; background-color: <? echo $color; ?>; color:white;" title="Debug CDI. Pour ouvrir cliquez !" /><em></em><?php
      ...
      ?><script>
          jQuery(document).ready(function(){ 
            ...
            jQuery(doclose).click(function(){
              ...
              jQuery('html, body').animate({ scrollTop: jQuery("#wpadminbar").offset().top }, 1000);
            } );
